  ...
  return (
    <div className="flex flex-col flex-grow space-y-5 mt-16 lg:mt-0">
      ...
      {repos.map(({ id, name, description, visibility, html_url, language, stargazers_count, updated_at }) => (
        <div key={id} className="py-5 px-10 bg-gray-100 rounded-md">
          <div className="flex justify-between">
            ...
            <button className="hidden md:flex items-center bg-gray-800 py-2 px-4 text-sm text-white rounded-md space-x-2 hover:bg-gray-700 transition duration-100">
          ...
          <p className="text-sm text-gray-600 mt-3 text-ellipsis whitespace-nowrap overflow-hidden">{description}</p>
